...
I finally managed to bring TSCH to LoRa in~\ref{section:tschtesting} by
demonstrating TSCH and LoRa integrate into the 6TiSCH networking stack.
...
SX1272 module.
This thesis showed the way on what it takes to adapt TSCH for a new radio
driver and re-implementation of this project with a module like SX1272 will then be
facilitated and would allow us to measure meaningful data.
Analysis of the accuracy and reliability of the network will then be possible.
A study on how longer sleeping periods de-synchronize the network or the period
...
The literature do not talk about using adaptive SF in a multi-hops
...
communicate over multiple channels with time-slots for better power usage 
