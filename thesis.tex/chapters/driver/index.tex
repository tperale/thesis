...
Each communication to and from the module are done via \emph{UART} ASCII command,
...
I took inspiration for the structure of my implementation structure by the work 
in~\cite{8847137} and \emph{RIOT-OS}
project\footnote{\url{https://github.com/RIOT-OS/RIOT}}, already took
care to define most of the parameters we want to use with the module.
...
Every message coming from the module are analyzed.
