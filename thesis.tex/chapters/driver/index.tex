...
It allow programmer to access LoRa different parameters from the code without
...
by redefining \lstinline{RN2483_DEV_CONF} and the current in use parameter are
accessed with \lstinline{RN2483_DEV}.
