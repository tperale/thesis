...
For this example, I will create a custom schedule and test if an application can
...
% Because of the missing functionality of the RN2483 module which allows to
% receive a signal at the start of the reception.
