...
This is why when the program busy wait with the command
...
Channel hopping is one of the main features of TSCH that need to be implemented
at the driver level.
...
I decided three different channels were enough for my testing and reduce the time
