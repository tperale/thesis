...
The figure~\ref{fig:retransmission} show the number of retransmission for each
...
those two nodes to proove the multihop function is correctly working.
...
Sending an UDP message to $:2dac$ worked seamlessly by passing by the
